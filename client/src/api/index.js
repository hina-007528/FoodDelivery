...
const API = axios.create({
  baseURL: process.env.REACT_APP_API_URL || "https://food-delivery-topaz-seven.vercel.app/api/",
});
...
export const getAllProducts = async (filter) =>
  await API.get(`food${filter ? `?${filter}` : ""}`, filter);
...
export const contactUs = async (data) => await API.post(`user/contact`, data);
